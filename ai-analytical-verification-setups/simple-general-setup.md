...
<task>
Analyze the content provided using the full verification pipeline defined below. Apply every step in order. Use the embedded reference tables as your analytical framework. Do not skip steps even if the content seems simple.
</task>
